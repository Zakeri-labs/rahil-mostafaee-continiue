  ...
  head: () => ({
    meta: [
      { title: "Iran-UAE Commercial and Financial Disputes" },
      {
        name: "description",
        content:
          "Legal route review for Iran-UAE commercial disputes, financial claims, unpaid receivables, asset recovery, and cross-border contract matters.",
      },
      {
        property: "og:title",
        content: "پرونده‌های تجاری ایران و امارات | اختلافات مالی و قراردادی",
      },
      {
        property: "og:description",
        content:
          "بررسی پرونده‌های تجاری و مالی ایران–امارات، اختلافات قراردادی، وصول مطالبات، بازیابی دارایی و مسیر حقوقی در امارات.",
      },
    ],
  }),
