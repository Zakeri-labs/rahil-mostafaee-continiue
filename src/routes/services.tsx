...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "خدمات وکیل تجاری در دبی و امارات برای ایرانی‌ها",
      },
      {
        property: "og:description",
        content:
          "خدمات حقوقی برای اختلافات تجاری ایران و امارات، بازیابی دارایی، وصول مطالبات، اختلاف شرکا و پرونده‌های مالی ایرانی‌ها در امارات.",
      },
    ],
  }),
          ...
          {cards.map((card) => (
            ...
            >
              ...
              <div className="mt-auto space-y-3">
                ...
                <div className="inline-flex items-center gap-2 pt-4 text-[10px] tracking-[0.25em] uppercase text-gold">
                  {t("svc.card.link")}{" "}
