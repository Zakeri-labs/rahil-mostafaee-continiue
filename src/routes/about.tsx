  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "About our focused approach to Iran-UAE commercial disputes, debt recovery, asset recovery, partner disputes, and confidential legal route review.",
      },
      {
        property: "og:title",
        content: "درباره رویکرد حقوقی در اختلافات تجاری و بازیابی دارایی امارات",
      },
      {
        property: "og:description",
        content:
          "درباره تمرکز ما بر اختلافات تجاری ایران و امارات، وصول مطالبات، بازیابی دارایی، اختلاف شرکا و بررسی محرمانه پرونده‌های مالی.",
      },
    ],
  }),
  component: AboutPage,
