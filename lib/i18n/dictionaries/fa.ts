...
export const fa: TranslationDictionary = {
  ...
  "contact.form.selectMatter": "نوع پرونده را انتخاب کنید",
  "contact.form.selectUrgency": "میزان فوریت را انتخاب کنید",
  "contact.form.submit": "ارسال برای بررسی محرمانه",
  "contact.form.submitting": "در حال ارسال امن…",
  "contact.form.disclaimer": "دریافت فرم به معنی پذیرش نمایندگی نیست؛ پرونده ابتدا باید بررسی شود.",
  "contact.form.error.required": "لطفاً این فیلد الزامی را تکمیل کنید.",
  "contact.form.error.nameTooShort": "لطفاً نام و نام خانوادگی خود را وارد کنید.",
  "contact.form.error.nameTooLong": "نام واردشده بیش از حد طولانی است.",
  "contact.form.error.invalidEmail": "لطفاً یک نشانی ایمیل معتبر وارد کنید.",
  "contact.form.error.emailTooLong": "نشانی ایمیل بیش از حد طولانی است.",
  "contact.form.error.invalidPhone": "لطفاً یک شماره تماس یا واتساپ معتبر وارد کنید.",
  "contact.form.error.phoneTooLong": "شماره تماس بیش از حد طولانی است.",
  "contact.form.error.contactMethodRequired": "لطفاً ایمیل یا شماره تلفن / واتساپ را وارد کنید.",
  "contact.form.error.languageTooLong": "نام زبان ترجیحی بیش از حد طولانی است.",
  "contact.form.error.amountTooLong": "مبلغ اختلاف بیش از حد طولانی است.",
  "contact.form.error.locationTooLong": "محل طرف مقابل بیش از حد طولانی است.",
  "contact.form.error.documentsTooLong": "توضیحات مدارک موجود بیش از حد طولانی است.",
  "contact.form.error.briefTooShort": "لطفاً حداقل ۳۰ نویسه درباره پرونده توضیح دهید.",
  "contact.form.error.briefTooLong": "خلاصه پرونده نباید بیشتر از ۲۰۰۰ نویسه باشد.",
  "contact.form.error.checkFields": "لطفاً فیلدهای مشخص‌شده را بررسی کنید.",
  "contact.form.error.submit":
    "ارسال درخواست انجام نشد. لطفاً اطلاعات را بررسی کرده و دوباره تلاش کنید.",
