...
export const en: TranslationDictionary = {
  ...
  "contact.form.selectMatter": "Select a matter type",
  "contact.form.selectUrgency": "Select the urgency",
  "contact.form.submit": "Submit for Confidential Review",
  "contact.form.submitting": "Submitting Securely…",
  "contact.form.disclaimer":
    "Receiving the form does not create representation. The matter must first be reviewed.",
  "contact.form.error.required": "Please complete this required field.",
  "contact.form.error.nameTooShort": "Please enter your full name.",
  "contact.form.error.nameTooLong": "The name is too long.",
  "contact.form.error.invalidEmail": "Please enter a valid email address.",
  "contact.form.error.emailTooLong": "The email address is too long.",
  "contact.form.error.invalidPhone": "Please enter a valid phone or WhatsApp number.",
  "contact.form.error.phoneTooLong": "The phone number is too long.",
  "contact.form.error.contactMethodRequired":
    "Please provide an email address or phone / WhatsApp number.",
  "contact.form.error.languageTooLong": "The preferred language is too long.",
  "contact.form.error.amountTooLong": "The disputed amount is too long.",
  "contact.form.error.locationTooLong": "The counterparty location is too long.",
  "contact.form.error.documentsTooLong": "The available-documents description is too long.",
  "contact.form.error.briefTooShort": "Please provide at least 30 characters of detail.",
  "contact.form.error.briefTooLong": "The description must not exceed 2,000 characters.",
  "contact.form.error.checkFields": "Please review the highlighted fields.",
  "contact.form.error.submit":
    "Your request could not be submitted. Please check the details and try again.",
